        ...
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p className="footer-description">
              Découvrez l'excellence automobile avec Porsche. Voitures neuves,
              d'occasion et accessoires premium.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="footer-social">
              <a
                href="https://facebook.com/porsche"
                target="_blank"
              ...
              <a
                href="https://instagram.com/porsche"
                target="_blank"
                rel="noopener noreferrer"
                className="footer-social-link"
