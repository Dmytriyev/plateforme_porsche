/**
 * components/modals/ContactModal.jsx — Formulaire de contact dans modal.
 *
...
const ContactModal = ({ onClose, vehiculeInfo = null }) => {
  ...
  useEffect(() => {
    // Intentional: synchronously set default form values when user or vehicle info
        ...
        <form onSubmit={handleSubmit} className="contact-modal-form">
          ...
          <div className="contact-modal-actions">
            <button
              type="button"
              onClick={onClose}
              className="contact-modal-btn-cancel"
            >
              Annuler
            </button>
