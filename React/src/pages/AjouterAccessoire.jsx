...
const AjouterAccessoire = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Créer l'accessoire
      const nouvelAccessoire =
        await accesoireService.createAccessoire(dataToSend);
      ...
      if (photos.length > 0 && nouvelAccessoire._id) {
        ...
        try {
          ...
          // Ne pas ignorer l'erreur silencieusement : journaliser aide au débogage
          warn("Erreur lors de l'envoi des photos pour l'accessoire :", photoErr);
        }
      }
  ...
  return (
    <div className="ajouter-accessoire-container">
      <div className="ajouter-accessoire-header">
        ...
        <p className="ajouter-accessoire-subtitle">
          Créez un nouvel accessoire Porsche
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="ajouter-accessoire-form">
        ...
        <div className="ajouter-accessoire-section">
          ...
          <div className="ajouter-accessoire-field">
            <label className="ajouter-accessoire-label">Stock</label>
            <input
              type="number"
              name="stock"
        ...
        <div className="ajouter-accessoire-section">
          ...
          <div className="ajouter-accessoire-field">
            <label className="ajouter-accessoire-label">Couleur</label>
            <select
        ...
        <div className="ajouter-accessoire-section">
          ...
          <div className="ajouter-accessoire-upload-area">
            ...
            <label
              ...
              className="ajouter-accessoire-upload-label"
            >
              <svg
                width="48"
                height="48"
