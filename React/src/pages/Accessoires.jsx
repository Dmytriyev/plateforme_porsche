                    ...
                    {isStaff && isStaff() && (
                      <div className="accessoire-card-admin-actions">
                        <button
                          ...
                          onClick={() => navigate(`/accessoires/${accessoire._id}/modifier`)}
                        >
                        ...
                        <button
                          ...
                          onClick={async () => {
                            if (window.confirm(`Êtes-vous sûr de vouloir supprimer "${accessoire.nom_accesoire}" ?`)) {
                              try {
                                await accesoireService.deleteAccessoire(accessoire._id);
