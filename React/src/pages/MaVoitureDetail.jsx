...
const MaVoitureDetail = () => {
    ...
    let photos = [];
    if (voiture.photo_voiture_actuel && Array.isArray(voiture.photo_voiture_actuel)) {
    ...
    const nomModele = voiture.type_model || voiture.nom_model ||
    ...
    const anneeProduction = voiture.annee_production ?
        new Date(voiture.annee_production).getFullYear() : null;
            ...
            <div className="ma-voiture-detail-content">
                ...
                <div className="ma-voiture-detail-info">
                    <div className="ma-voiture-detail-section">
                        <h2 className="ma-voiture-detail-section-title">Informations générales</h2>
                        <div className="ma-voiture-detail-grid">
                            {typeCarrosserie && (
                                <div className="ma-voiture-detail-item">
                                    <span className="ma-voiture-detail-label">Type de carrosserie</span>
                                    <span className="ma-voiture-detail-value">{typeCarrosserie}</span>
                                </div>
                            )}
                            {anneeProduction && (
                                <div className="ma-voiture-detail-item">
                                    <span className="ma-voiture-detail-label">Année de production</span>
                                    <span className="ma-voiture-detail-value">{anneeProduction}</span>
                                </div>
                            )}
                            {voiture.couleur_exterieur && (
                                <div className="ma-voiture-detail-item">
                                    <span className="ma-voiture-detail-label">Couleur extérieure</span>
                            ...
                            {voiture.couleur_interieur && (
                                <div className="ma-voiture-detail-item">
                                    <span className="ma-voiture-detail-label">Couleur intérieure</span>
                                    <span className="ma-voiture-detail-value">
                            ...
                            {voiture.taille_jante && (
                                <div className="ma-voiture-detail-item">
                                    ...
                                    <span className="ma-voiture-detail-value">
                                        {voiture.taille_jante.taille_jante}" - {voiture.taille_jante.description || ''}
                                    </span>
                                </div>
                            )}
                            {voiture.siege && (
                            ...
                            {voiture.package_weissach !== undefined && (
                                <div className="ma-voiture-detail-item">
                                    <span className="ma-voiture-detail-label">Package Weissach</span>
                                    <span className="ma-voiture-detail-value">
                    ...
                    {voiture.specifications && (
                        <div className="ma-voiture-detail-section">
                            <h2 className="ma-voiture-detail-section-title">Spécifications techniques</h2>
                            <div className="ma-voiture-detail-grid">
                                ...
                                {voiture.specifications.vitesse_max && (
                                    <div className="ma-voiture-detail-item">
                                        <span className="ma-voiture-detail-label">Vitesse maximale</span>
                                        <span className="ma-voiture-detail-value">
                                ...
                                {voiture.specifications.consommation && (
                                    <div className="ma-voiture-detail-item">
                                        <span className="ma-voiture-detail-label">Consommation</span>
                                        <span className="ma-voiture-detail-value">
                                ...
                                {voiture.specifications.motorisation && (
                                    <div className="ma-voiture-detail-item">
                                        <span className="ma-voiture-detail-label">Motorisation</span>
                                        <span className="ma-voiture-detail-value">
                                            {voiture.specifications.motorisation}
                                        </span>
                                    </div>
